...
PARAMETER
{
  ...
  ah = -0.14590168177876242     (/mV) 
  bh = 6.938120093526114     (1) 
  ...
  anf = 0.12323812220640122     (/mV) 
  bnf = -3.264326629941031     (1) 
  ...
  am = 0.12474041071500426     (/mV) 
  bm = -3.616150762419472     (1) 
  ...
  ans = 0.12340021596544587     (/mV) 
  bns = -4.7508666319800215     (1) 
