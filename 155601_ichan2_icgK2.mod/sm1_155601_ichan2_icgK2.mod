...
PARAMETER
{
  ...
  ah = -0.145901681536604     (/mV) 
  bh = 6.938120080680591     (1) 
  ...
  anf = 0.12323819225157048     (/mV) 
  bnf = -3.264328960346425     (1) 
  ...
  am = 0.12474038911111877     (/mV) 
  bm = -3.616150138562845     (1) 
  ...
  ans = 0.12340017601641205     (/mV) 
  bns = -4.750864824653954     (1) 
