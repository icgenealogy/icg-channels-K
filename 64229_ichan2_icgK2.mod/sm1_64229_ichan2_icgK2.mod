...
PARAMETER
{
  ...
  ah = -0.14590168045087612     (/mV) 
  bh = 6.938120023837682     (1) 
  ...
  anf = 0.12323819296696327     (/mV) 
  bnf = -3.264328984502988     (1) 
  ...
  am = 0.12474041026436639     (/mV) 
  bm = -3.6161507489951186     (1) 
  ...
  ans = 0.12340023387012149     (/mV) 
  bns = -4.750867441216647     (1) 
