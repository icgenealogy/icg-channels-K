...
PARAMETER {
    ...
    gbar  = 0.036  (S/cm2)     : maximum potassium conductance
...
INITIAL {
    ...
    Nk = ceil(((1e-8)*area)*(gbar)/((1e-12)*gamma_k))   : area in um2 -> 1e-8*area in cm2; gbar in S/cm2; gamma_k in pS -> 1e-12*gamma_k in S
