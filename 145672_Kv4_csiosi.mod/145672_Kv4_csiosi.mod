:Kv4 CSI+OSI Markov model from Fineberg, Ritter and Covarrubias J Gen Physiol (2012)
:for scheme see Fig. S1 and Table S1 or file "IonChannelLab Files/Kv4 CSIOSI.ichl"
:based on Amarillo et al. J Physiol (2008), Dougherty et al J Gen Physiol (2008), 
:and Migliore et al J Comp Neurosci(1999)
...
PARAMETER {
	...
	za = 0.315646648				
      	...
      	zb = -2.062276				
	c = 1.01216107		(/ms)		:gamma transitions
	zc = 0.500095665
	d = 2.498881		(/ms)		:delta transitions
	zd = -1.1546687
	...
	koi = 0.5195		(/ms)		:kappa1 transition
	kio = 0.0436		(/ms)		:lambda1 transition
	kii2 = 0.1475		(/ms)		:kappa2 transition
	ki2i = 0.0333		(/ms)		:lambda2 transition
}
...
KINETIC states {   		
	...
	~O <-> I6 (kOIf, kOIb)
	~I6 <-> I7 (kII2f, kII2b)
	CONSERVE C0+C1+C2+C3+C4+C5+I0+I1+I2+I3+I4+I5+O+I6+I7=1
}
...
PROCEDURE rates(v(millivolt)) {
      ...
      kOIf = koi						:open to inactivated transitions		
      kOIb = kio
      kII2f = kii2					
      kII2b = ki2i
}
