...
PARAMETER
{
  ...
  ah = -0.1459016818262323     (/mV) 
  bh = 6.938120095927059     (1) 
  ...
  anf = 0.12323816301275034     (/mV) 
  bnf = -3.2643279853817386     (1) 
  ...
  am = 0.12474041085128917     (/mV) 
  bm = -3.6161507661743397     (1) 
  ...
  ans = 0.12340017993186493     (/mV) 
  bns = -4.750865001106781     (1) 
