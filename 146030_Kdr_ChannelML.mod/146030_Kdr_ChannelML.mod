COMMENT
   ...
   **************************************************
   ...
   /channelml/channel_type/current_voltage_relation/ohmic/conductance/@default_gbar = 36 
...
PARAMETER { 
    ...
    gbar = 0.036 (S/cm2) ? default value, should be overwritten when conductance placed on cell
